 ...
 */
public class En_Com_AsyncTask extends AsyncTask<String, Integer, Long>{
    ...
    public En_Com_AsyncTask(Context context1, Activity activity1, ProgressDialog progressDialog1, View view1, EditText editText1){
    ...
    protected Long doInBackground(String... strings) {
        ...
        // encrypt
        text_encrypt = encrypt.Encrypt(params,publicKey_onload,text_com);
