 ...
 */
public class Si_En_AsyncTask extends AsyncTask<String, Integer, Long>{
    ...
    public Si_En_AsyncTask(Context context1, Activity activity1, ProgressDialog progressDialog1, View view1, EditText editText1){
    ...
    protected Long doInBackground(String... strings) {
        ...
        // sing
        String text_sing = sing.Signature(original_text,privateKey_onload);
        text_sing = "@S$"+original_text+"#S#"+text_sing;
