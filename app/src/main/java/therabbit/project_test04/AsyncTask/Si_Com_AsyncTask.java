 ...
 */
public class Si_Com_AsyncTask extends AsyncTask<String, Integer, Long>{
    ...
    String text_encrypt;
    private String text_sing;

    public Si_Com_AsyncTask(Context context1, Activity activity1, ProgressDialog progressDialog1, View view1, EditText editText1){
    ...
    protected Long doInBackground(String... strings) {
        ...
        // sing
        text_sing = sing.Signature(text_com,privateKey_onload);
    ...
    protected void onPostExecute(Long aLong) {
        ...
        if (progressDialog.isShowing()) {
            ...
            int sms = smsLengthCalculator.getPartCount(text_sing);
            showDialogConfirm(sms,text_sing);
            Log.d("SMS Length: ",text_sing);
            Log.d("Length : ",text_sing.length()+"");
