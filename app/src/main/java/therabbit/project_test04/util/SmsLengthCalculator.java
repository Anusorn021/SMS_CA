 ...
 * Created by Nutherabbit on 25/7/2559.
 */
...
public class SmsLengthCalculator {
    ...
    public static void main(String[] args) {
        ...
        String txt = "วันนี้คุณสามารถจ่ายบิลค่ามือถือ ค่าไฟ ค่าบัตรเครดิตผ่านทีเอ็มบี ทัช ได้ง่ายๆ แค่สแกน แล้วกดจ่าย เหมือนมีธนาคารพกติดตัว วิธีทำคลิ๊ก https://www.tmbbank.com/howto/app/pay-bill.php\n" +
                "#S#MEQCIGPrkaOac1koyIW4o7X8R//2juf8sY3OAw1cfPie92ilAiAd1ZRxOsPQzpf5nQelwpfP2/VwCfYw5RxZGfv7xg7krw==";
